...
class Mymo2 extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('My Mo2');
        ...
        $this->templateFile = 'module:mymo2/mymo2.tpl';
    }
    ...
    {
        Configuration::updateValue('MYMO2_FACEBOOK', '');
        Configuration::updateValue('MYMO2_TWITTER', '');
    ...
    {
        Configuration::deleteByName('MYMO2_LIVE_MODE');
